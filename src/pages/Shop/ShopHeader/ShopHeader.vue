<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShop">
      <img :src="shopInfo.avatar" class="content-image">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow" >
        <div class="activity-sheet-content">
          ...
          <ul class="list" >
            <li class="activity-item" :class="supportClasses[support.type]" v-for="(support, index) in shopInfo.supports" :key="index">
            <span class="content-tag">
              <span class="mini-tag">{{shopInfo.supports[index].name}}</span>
            </span>
              <span class="activity-content">{{shopInfo.supports[index].content}}</span>
            </li>
...
<script>
  ...
  export default { //向外暴露
    ...
    computed: {
      ...mapState(['shopInfo','userInfo']) //两种形式都可以
    },
    methods: {
      toggleSupports(){
